...
When adding new test octads, ensure:

1. The octad ID is unique across all seed scripts
2. The same octad is created in all relevant databases (for federation testing)
3. Drift scores and provenance events reference valid octad IDs
