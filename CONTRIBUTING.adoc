...
Thank you for your interest in contributing to VeriSimDB. This document
explains how to get started, our development workflow, and how to submit
changes.
...
* *Rust* (nightly) — `+asdf install rust nightly+` or
`+rustup install nightly+`
* *Elixir* 1.17+ with Erlang/OTP 27+ — `+asdf install elixir+` /
`+asdf install erlang+`
...
*Before reporting*: 1. Search existing issues on
https://github.com/hyperpolymath/verisimdb/issues[GitHub] or
https://gitlab.com/hyperpolymath/verisimdb/-/issues[GitLab] 2. Check if
it’s already fixed in `+main+`

*When reporting*, include: - Clear, descriptive title - Environment
details (OS, Rust version, Elixir version) - Steps to reproduce -
Expected vs actual behaviour - Logs, error messages, or minimal
reproduction
...
*When suggesting*, include: - Problem statement (what pain point does
this solve?) - Proposed solution - Alternatives considered - Which
modality or component it affects

==== Your First Contribution

Look for issues labelled: -
https://github.com/hyperpolymath/verisimdb/labels/good%20first%20issue[`+good first issue+`]
— Simple tasks -
https://github.com/hyperpolymath/verisimdb/labels/help%20wanted[`+help wanted+`]
— Community help needed -
https://github.com/hyperpolymath/verisimdb/labels/documentation[`+documentation+`]
— Docs improvements
...
under the *MPL-2.0*. All source files must include:
...
* *Issues*: https://github.com/hyperpolymath/verisimdb/issues[GitHub] or
https://gitlab.com/hyperpolymath/verisimdb/-/issues[GitLab]
