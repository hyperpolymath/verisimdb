...
**Scope:** Not VCL-DT.  Just VQL.  The query language that end users type.
...
=== Priority 7: Wire VCL-DT (HIGH — but after VQL)
...
7. **Wire VCL-DT** so the technical moat is _operational_ (after VQL is solid)
