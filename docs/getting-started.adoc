...
VeriSimDB uses its own query language, *VQL* (VeriSim Consonance Language),
...
VCL-DT extends VQL with proof certificates. Every result includes a
...
* Read the link:VCL-SPEC.adoc[VQL Specification] for the full query language
* See link:vcl-examples.adoc[VQL Examples] for more query patterns
