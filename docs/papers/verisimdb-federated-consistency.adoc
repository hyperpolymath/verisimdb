...
VeriSimDB is open source under the Mozilla Public License 2.0 (MPL-2.0), with the Rust core, Elixir orchestration layer, and VCL parser available at https://github.com/hyperpolymath/verisimdb.
