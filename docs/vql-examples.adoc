...
This document provides **42 comprehensive examples** of VQL queries for both **dependent-type** (formally verified) and **slipstream** (fast, unverified) paths, including backwards compatibility (VERSION) and drift handling (DRIFT REPAIR) features.
