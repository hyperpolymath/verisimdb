...
- **Write Coalescing:** Merge multiple updates to same Octad before persisting
...
- **Manual Sharding:** Split Octads across multiple standalone nodes → lose single-system image
