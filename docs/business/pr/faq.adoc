...
VCL-DT is an optional extension to VQL that adds dependent-type verification.
...
VCL-DT is entirely optional. Teams can use plain VQL for standard operations and
...
4. Explore the VQL examples: `docs/vcl-examples.adoc`
...
* *VQL specification:* `docs/VCL-SPEC.adoc`
