...
Proof Computation: proven generates a proof $\pi$ that the private data satisfies the contract constraints.

Sactify Wrapping: The proof $\pi$ is packaged into a sactify-php signature block.
