...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/verisimdb/security/advisories/new)
...
- This repository (`hyperpolymath/verisimdb`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/verisimdb/security/advisories)
...
When using VeriSimDB, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/verisimdb/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/verisimdb/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/verisimdb/discussions) |
...
*Thank you for helping keep VeriSimDB and its users safe.* 🛡️
